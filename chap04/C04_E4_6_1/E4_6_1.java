...
public class E4_6_1 {	//クラス「E4_6_1」の宣言
	...
	public static void main(String[] args) {	//mainメソッドの宣言
		...
		//表示させるアスタリスクの個数を入力するよう促すメッセージを表示
		System.out.print("何個*を表示しますか：");

		//変数「iPutAstN」をint型で作成し、キーボードから入力された整数値を代入
		int iPutAstN = iStdIn.nextInt();

		//while文の終了判定に使用する変数「iCount」をint型で作成し、「0」で初期化
		int iCount = 0;
